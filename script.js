...
function updateScrollingSpeed() {
  document.querySelectorAll(".is--scrolling").forEach((e) => {
    let n = e.offsetWidth;
    e.style.setProperty("--scroll-width", `${n}px`),
      (e.style.animationDuration = `${n / 50}s`);
  });
}
...
function appendSourceToLink(e, n) {
  let t = new URL(e.href);
  t.searchParams.set("source", n), (e.href = t.toString());
}
...
updateScrollingSpeed(),
  ...
  document.addEventListener("DOMContentLoaded", function () {
    let e = document.querySelector(".navbar"),
      n = document.querySelectorAll(".navbar--dropdown-new"),
      t = null,
      o = (e) => {
        if (!e) return;
        let n = e.querySelector(".navbar--dropdown-list-new"),
          t = e.querySelector(".navbar--dropdown-icon");
        gsap.to(n, {
          opacity: 0,
          y: "20rem",
          duration: 0.3,
          ...
          gsap.to(t, { rotation: 0, duration: 0.3, ease: "smooth" });
      },
      a = () => {
        n.forEach((n) => {
          n.addEventListener("mouseenter", () => {
            e.classList.add("is--active");
            let a = n.querySelector(".navbar--dropdown-icon");
            t && t !== n && o(t), (t = n);
            let r = n.querySelector(".navbar--dropdown-list-new");
            ...
            n.addEventListener("mouseleave", (a) => {
              e.contains(a.relatedTarget) ||
                (o(n), (t = null), e.classList.remove("is--active"));
            });
        }),
          e.addEventListener("mouseleave", () => {
            t && (o(t), (t = null)), e.classList.remove("is--active");
          });
      },
      r = () => {
        n.forEach((e) => {
